                //Esse eu assunto eu patinei, triste fim
...
{   
    ...
    cout << " ) e positivos ( " << int(letra) << " )." << endl;
                //O tipo char é usado para armazenar caracteres individuais, 
                //não números inteiros, e seu intervalo é geralmente de -128 a 127 
                //ou 0 a 255 (se for sem sinal).
